...
const Wallet = () => {
  ...
  return (
    <>
      ...
      {/* BNB Modal */}
      <Modal
        isVisible={isBNBModalVisible}
        onBackdropPress={toggleBNBModal}
        style={styles.modalContainer}
        animationIn="slideInUp"
        animationOut="slideOutDown"
        backdropOpacity={0.5}
        ...
        <View
          ...
          <View>
            <View
              ...
              <TouchableOpacity onPress={toggleBNBModal}>
                <SvgXml xml={assets.back} />
              </TouchableOpacity>
              <View>
                <Text
      ...
      <Modal
        isVisible={isEthereumModalVisible}
        onBackdropPress={toggleEthereumModal}
        style={styles.modalContainer}
        animationIn="slideInUp"
        animationOut="slideOutDown"
        backdropOpacity={0.5}
        ...
        <View
          ...
          <View>
            <View
              ...
              <TouchableOpacity onPress={toggleEthereumModal}>
                <SvgXml xml={assets.back} />
              </TouchableOpacity>
              <View>
                <Text
      ...
      {/* Polygon Modal */}
      <Modal
        isVisible={isPolygonModalVisible}
        onBackdropPress={togglePolygonModal}
        style={styles.modalContainer}
        animationIn="slideInUp"
        animationOut="slideOutDown"
        backdropOpacity={0.5}
        ...
        <View
          ...
          <View>
            <View
              ...
              <TouchableOpacity onPress={togglePolygonModal}>
                <SvgXml xml={assets.back} />
              </TouchableOpacity>
              <View>
                <Text
      ...
      {/* AVAX Modal */}
      <Modal
        isVisible={isAVAXModalVisible}
        onBackdropPress={toggleAVAXModal}
        style={styles.modalContainer}
        animationIn="slideInUp"
        animationOut="slideOutDown"
        backdropOpacity={0.5}
        ...
        <View
          ...
          <View>
            <View
              ...
              <TouchableOpacity onPress={toggleAVAXModal}>
                <SvgXml xml={assets.back} />
              </TouchableOpacity>
              <View>
                <Text
